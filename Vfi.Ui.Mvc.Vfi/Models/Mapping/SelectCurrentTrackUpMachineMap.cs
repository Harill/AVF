...
{
    public class SelectCurrentTrackUpMachineMap : EntityTypeConfiguration<SelectCurrentTrackUpMachine>
    {
        public SelectCurrentTrackUpMachineMap()
        {
            // Primary Key
            this.HasKey(t => new { t.MachineId, t.TrackId, t.Expr1, t.ProductId, t.RoundPerMinute, t.RealProductivity, t.RealRate, t.WorkPiece, t.KnifeCut, t.Status, t.ModifiedDate, t.StartDate, t.Quantity, t.EndDate, t.ForecastDay, t.ForecastDate });
            ...
            this.ToTable("SelectCurrentTrackUpMachine");
