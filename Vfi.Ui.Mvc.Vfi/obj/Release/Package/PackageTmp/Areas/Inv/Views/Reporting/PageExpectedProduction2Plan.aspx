...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptExpectedProduction2Plan();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageExpectedProduction2Plan.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageExpectedProduction2Plan" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
