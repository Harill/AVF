...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptPrintNewAssignMaterial();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPagePrintNewAssignMaterial.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPagePrintNewAssignMaterial" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
