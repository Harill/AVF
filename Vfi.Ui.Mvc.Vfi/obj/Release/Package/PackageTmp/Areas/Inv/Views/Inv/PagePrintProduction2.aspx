...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptPrintProductionForm2();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPagePrintProduction2.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPagePrintProduction2" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
