...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptProductionWeeklySX1();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageProductionWeeklySX1.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageProductionWeeklySX1" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
