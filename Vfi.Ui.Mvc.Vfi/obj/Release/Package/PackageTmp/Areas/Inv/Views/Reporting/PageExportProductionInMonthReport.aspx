...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptExportInMonth();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageExportProductionInMonthReportt.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageExportProductionInMonthReportt" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
