...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptProductionDefectDaily();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageProductionDefectDaily.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageProductionDefectDaily" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
