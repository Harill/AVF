...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptFinishedProductionReport();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageFinishedProductionReport.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageFinishedProductionReport" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
