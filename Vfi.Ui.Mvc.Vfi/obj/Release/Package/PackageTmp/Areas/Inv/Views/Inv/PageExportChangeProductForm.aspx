...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptExportChangeProductForm();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageExportChangeProductForm.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageExportChangeProductForm" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
