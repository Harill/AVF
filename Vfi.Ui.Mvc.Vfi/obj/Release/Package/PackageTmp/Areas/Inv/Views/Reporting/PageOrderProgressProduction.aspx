...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptOrderProgressProduction();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageOrderProgressProduction.Report = rp;
    }
...
<telerik:ReportViewer ID="rptvPageOrderProgressProduction" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
