...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptOrderProgressInMonth();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageOrderProgressInMonth.Report = rp;
    }
...
<telerik:ReportViewer ID="rptvPageOrderProgressInMonth" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
