...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptTaxInvoiceProductDetail();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageTaxInvoiceProductDetail.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageTaxInvoiceProductDetail" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
