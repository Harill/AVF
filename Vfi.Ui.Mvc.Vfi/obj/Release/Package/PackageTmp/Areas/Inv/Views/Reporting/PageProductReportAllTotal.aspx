...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptProductAllTotal();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageReportProductInvAllTotal.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageReportProductInvAllTotal" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
