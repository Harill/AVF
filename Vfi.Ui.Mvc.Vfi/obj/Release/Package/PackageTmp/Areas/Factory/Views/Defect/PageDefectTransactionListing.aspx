...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptDefectReportForm();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageRptDefectReportForm.Report = rp;   
    }
...
--%>
<telerik:ReportViewer ID="rptvPageRptDefectReportForm" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
