...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptTrackUpMachine();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageTrackUpMachineReport.Report = rp;   
    }
...
--%>
<telerik:ReportViewer ID="rptvPageTrackUpMachineReport" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
