...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new Vfi.Ui.Mvc.Vfi.Areas.Inv.Reports.RptInquiryForm();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPagePrintInquiryForm.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPagePrintInquiryForm" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
