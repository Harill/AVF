...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new Vfi.Ui.Mvc.Vfi.Areas.Inv.Reports.RptPurchaseOrderDetail();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPagePrintPurchaseOrderDetail.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPagePrintPurchaseOrderDetail" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
