...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new Vfi.Ui.Mvc.Vfi.Areas.Inv.Reports.RptImportFuelForm();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageImportFuelForm.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageImportFuelForm" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
