...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptProductTechnicalList();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageProductTechnicalList.Report = rp;   
    }
...
--%>
<telerik:ReportViewer ID="rptvPageProductTechnicalList" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
