...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new Vfi.Ui.Mvc.Vfi.Areas.Inv.Reports.RptPlatingForm();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPagePrinPlatingForm.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPagePrinPlatingForm" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
