...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new Vfi.Ui.Mvc.Vfi.Areas.Inv.Reports.RptPurchaseOrderTracking();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPagePrintPurchaseOrderTracking.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPagePrintPurchaseOrderTracking" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
