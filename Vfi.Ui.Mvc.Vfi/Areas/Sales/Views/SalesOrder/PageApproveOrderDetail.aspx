...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptApproveOrderDetailForm();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageApproveOrderDetailForm.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageApproveOrderDetailForm" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
