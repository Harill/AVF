...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptMachineRepairHandover();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageErrorMachineList.Report = rp;   
    }
...
--%>
<telerik:ReportViewer ID="rptvPageErrorMachineList" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
