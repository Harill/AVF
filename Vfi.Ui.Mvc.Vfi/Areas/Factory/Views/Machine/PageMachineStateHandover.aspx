...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptMachineStateHandover();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageMachineStateHandover.Report = rp;   
    }
...
--%>
<telerik:ReportViewer ID="rptvPageMachineStateHandover" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
