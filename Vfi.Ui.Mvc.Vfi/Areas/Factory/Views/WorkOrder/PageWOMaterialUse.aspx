...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptPrintMaterialUseForm2();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPagePrintWOAssignMaterial.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPagePrintWOAssignMaterial" runat="server" Width="100%" Height="100%" >
