...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptWorkOrderFinishCard();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageWorkOrderFinishBarcode.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageWorkOrderFinishBarcode" runat="server" Width="100%" Height="100%" >
