...
namespace Vfi.Ui.Mvc.Vfi.Areas.Inv.Reports
{
    ...
    /// </summary>
    public partial class RptProductionDailySX1_2023 : Telerik.Reporting.Report
    {
        public RptProductionDailySX1_2023()
        {
            //
        ...
        public static double GetValueByShift(List<Shift> list, string shiftName, int valueGet)
        {
            try
            {
                ...
                switch (valueGet)
                {
                    ...
                    case 8:
                        return shift.TotalQuantity;
                    case 9:
                        return shift.MaterialProductionRate;
                    case 10:
                        return shift.ProductionMaterialPlan;
                    case 11:
                        return shift.MaterialDiffCost;
                    case 12:
                        return shift.MaterialDiff;
                    case 13:
                        return shift.NGCost;
                    case 14:
                        return shift.Count;
                    case 15:
                        return shift.ProductivityInShift;
                }
            }
            catch (Exception ex)
            {
