...
namespace Vfi.Ui.Mvc.Vfi.Areas.Inv.Reports
{
    ...
    /// </summary>
    public partial class RptTaxInvoiceProductDetail : Telerik.Reporting.Report
    {
        public RptTaxInvoiceProductDetail()
        {
            //
            ...
            this.Name = "BaoCaoChiTietXuatThanhPham";
        }
        ...
        public static string Title(DateTime? date)
        {
            if (date == null)
                return "XUẤT THÀNH PHẨM";
            else
                return "XUẤT THÀNH PHẨM THÁNG " + date.Value.ToString("MM/yyyy");
        }
