...
namespace Vfi.Ui.Mvc.Vfi.Areas.Inv.Controllers
{
    public class StockOrderTypeController : Controller
    {
        ...
        public StockOrderTypeController(IUnitOfWork unitOfWork
        ...
        {
            return new List<StockOrderTypeModel>();
            //try
            //{
        ...
        public ActionResult SelectComboBoxStockOrderType()
        {
            ...
            {
                Data = new SelectList(GetStockOrderTypeModels().Where(f => f.Active), "StockOrderTypeId", "StockOrderTypeName")
            };
        }
