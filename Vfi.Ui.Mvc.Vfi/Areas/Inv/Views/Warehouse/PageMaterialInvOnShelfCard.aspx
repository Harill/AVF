...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptMaterialOnShelfCard();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvRptMaterialOnShelfCard.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvRptMaterialOnShelfCard" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
