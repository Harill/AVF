...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptProductionDailySX1();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageProductionDailySX1.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageProductionDailySX1" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
