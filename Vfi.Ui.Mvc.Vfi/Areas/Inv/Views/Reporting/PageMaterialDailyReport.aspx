...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptMaterialDailyReport();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageMaterialDailyReport.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageMaterialDailyReport" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
