...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptMachineProductionOnTest();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageMachineProductionOnTest.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageMachineProductionOnTest" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
