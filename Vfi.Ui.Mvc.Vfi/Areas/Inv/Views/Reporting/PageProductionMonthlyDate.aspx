...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptProductionMonthlyDate();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageProductionMonthlyDate.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageProductionMonthlyDate" runat="server" Width="100%" Height="100%" >
