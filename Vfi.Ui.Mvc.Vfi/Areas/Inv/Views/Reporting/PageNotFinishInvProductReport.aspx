...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptNotFinishInvProduct();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageNotFinishInvProduct.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageNotFinishInvProduct" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
