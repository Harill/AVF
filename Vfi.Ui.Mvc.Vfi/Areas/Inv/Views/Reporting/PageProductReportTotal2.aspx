...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptProductTotal3();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageReportProductInvTotal2.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageReportProductInvTotal2" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
