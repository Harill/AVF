...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptDeliverySalesReport();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageDeliverySalesReport.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageDeliverySalesReport" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
