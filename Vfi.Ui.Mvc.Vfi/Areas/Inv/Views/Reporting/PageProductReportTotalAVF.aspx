...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptProductTotalAVF();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageReportProductInvTotal.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageReportProductInvTotal" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
