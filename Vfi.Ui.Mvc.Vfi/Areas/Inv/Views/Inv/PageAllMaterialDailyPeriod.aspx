...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptMaterialDailyPeriod();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageMaterialDailyPeriod.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageMaterialDailyPeriod" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
