...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptTransactionFormGroup();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageTransactionFormGroup.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageTransactionFormGroup" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
