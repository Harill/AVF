...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        var rp = new RptInvoice_ExportForm();
        //rp.ReferenceTypeParam = "M";
        
        //rp.BindDataOwner();
        rp.BindDataOwner(Model);

        rptvPageInvoice_ExportForm.Report = rp;   
    }
...
<telerik:ReportViewer ID="rptvPageInvoice_ExportForm" runat="server" Width="100%" Height="100%" >
</telerik:ReportViewer>
